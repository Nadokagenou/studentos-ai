...
const CACHE = 'studentos-1b82-signal';   // ขึ้นเวอร์ชันทุกครั้งที่ปล่อย ของเก่าถูกลบตอน activate
const SHELL = ['.', 'index.html', 'manifest.json',
  'style.css', 'alt.css', 'inbox.css', 'today.css', 'room.css', 'social.css', 'feed.css', 'safety.css', 'hw.css', 'topic.css', 'custom.css',
  'config.js', 'engine.js', 'context.js', 'planner.js', 'room.js', 'facts.js', 'profile.js', 'simulate.js', 'calibrate.js', 'loss.js', 'decide.js', 'brain.js', 'inbox.js', 'linelink.js', 'safety.js', 'app.js',
