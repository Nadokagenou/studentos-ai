...
const APP_VERSION = '1C10';                 // สายเลขของแอป
const APP_CODENAME = 'Colour';           // ชื่อรุ่นของอัปเดตนี้
...
// ในหน้าฟีเจอร์อื่น ๆ กับลิงก์ในหน้าโปรไฟล์แทน (ดูเหตุผลด้านความปลอดภัยใน index.html)
...
const TAB_OWNER = { 'scr-timeline': 'scr-tasks',
  ...
  // (วันนี้ → ฟีเจอร์อื่น ๆ → เพื่อนฉัน) ไม่งั้นเปิดฟีดแล้วไม่มีแท็บไหนสว่างสักอัน
  'scr-mates': 'scr-menu',
...
function renderTabBadges() {
  ...
  // ปิด features.social ตอนนี้กรองแค่ไทล์ "เพื่อนฉัน" ในหน้าฟีเจอร์อื่น ๆ ซึ่งพอแล้ว
