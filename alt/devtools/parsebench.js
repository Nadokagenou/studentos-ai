...
const PARSE_CASES = [
  ...
  // "Xหน้า" ที่ X คือวันนี้พอดี = อีก 7 วัน ไม่ใช่ 14 — เคยบวกสัปดาห์ซ้ำสองรอบ
  // (เจอจริง 24 ก.ย. 69 วันพฤหัส: "สอบย่อยฟิสิกส์ พฤหัสหน้า" ได้ 8 ต.ค. แทน 1 ต.ค.)
  { g: 'due', id: 'วันนี้+หน้า', text: 'ส่งรายงานพุธหน้า', want: { due: DOW(3) } },
  // คุมไว้ไม่ให้แก้เกิน: วันอื่นที่ "หน้า" ยังต้องเป็นวันนั้นของสัปดาห์ถัดไป (พุธ→ศุกร์หน้า = 9 วัน)
  { g: 'due', id: 'วันอื่น+หน้า', text: 'ส่งศุกร์หน้า', want: { due: D(9) } },
