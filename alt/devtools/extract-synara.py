...
# ⚠️ ชิบิ **ไม่ตัดพื้นหลัง** แล้วตั้งแต่ 1C23 — และห้ามกลับไปตัดอีก
# ลองมาสามรอบ ทุกรอบพังคนละแบบ:
#   tol ต่ำ  → พื้นหลังเหลือเป็นรัศมีรอบตัว
#   tol สูง  → กินผมกับเสื้อคลุมจนตัวขาด (เจ้าของ: "น้องไซก็ตัวขาดเหมือนเดิม")
#   despeckle เก็บเฉพาะก้อนใหญ่สุด → ปอยผม/รองเท้า/ของในมือที่ขาดจากตัวตอน erode
#                                     ถูกลบทิ้งทั้งชิ้น
# เหตุผลที่ตัดไม่ได้จริง ๆ ไม่ใช่เพราะ algorithm ไม่ดีพอ: ผมสีเงินกับเสื้อคลุมขาวโปร่ง
# มีค่าสีอยู่ในระยะเดียวกับพื้นหลังฟ้าอ่อน (วัดได้ห่างกัน ~24 จาก 765)
# ไม่มีเกณฑ์ไหนแยกสองอย่างนี้ออกจากกันได้ เพราะมัน *เป็น* สีเดียวกันจริง ๆ
# ต้องให้คนตัดด้วยมือ หรือขอไฟล์ PNG พื้นโปร่งจากคนวาด
chibi = src.crop((988, 612, 1178, 940)).convert('RGBA')
