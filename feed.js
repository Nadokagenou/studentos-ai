...
const FAB_HIDE = ['scr-login', 'scr-onboard', 'scr-chat', 'scr-hw', 'scr-profile',
  ...
  'scr-ttscan', 'scr-shot',
  // 1C18 · ห้องคุยแผนมีปุ่มเดียวคือ "ต่อไป" — ปุ่มลอยที่นั่งทับ "ข้ามไปก่อน"
  // คือปุ่มที่แข่งกับจังหวะเดียวของทั้งจอ
  'scr-sai',
  // 1C26 · ห้องน้องไซตกหล่นจากรายการนี้มาตั้งแต่ต้น ทั้งที่เข้าเกณฑ์เดิมเป๊ะ —
  // มีช่องพิมพ์ติดก้นจอ และปุ่มลอย 52px มุมขวาล่างนั่งทับ .sb-send (36px) เต็ม ๆ
  // บนจอมือถือ พิมพ์คำถามแล้วกดส่ง จึงได้แผ่นผู้ช่วยเด้งขึ้นมาแทน คำถามค้างอยู่ในช่อง
  // อ่านได้ว่า "น้องไซใช้งานไม่ได้" · และปุ่มนี้ซ้ำซ้อนอยู่แล้วบนจอนี้ —
  // มันเปิดผู้ช่วย ส่วนนี่คือห้องของผู้ช่วยเอง
  'scr-ai',
  'scr-form'];
